    ...
    <section id="contact" className="bg-gray-50 py-32">
      <MaxWidthWrapper>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="w-full rounded-lg overflow-hidden shadow-lg hover:scale-105 transition-transform duration-200">
            <iframe
              ...
              width="100%"
              height="100%" // This will make the iframe match the height of the ContactCard in the same grid row
